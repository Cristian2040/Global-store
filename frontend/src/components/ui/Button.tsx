...
export function Button({
    ...
    const variants = {
        primary: 'bg-gradient-to-r from-cyan-600 via-blue-600 to-purple-600 text-white hover:from-cyan-700 hover:via-blue-700 hover:to-purple-700 focus:ring-blue-500',
