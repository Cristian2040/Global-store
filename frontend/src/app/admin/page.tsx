        ...
        <DashboardLayout role="admin" title="Panel de Administración">
            <div className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-8 text-white">
                    ...
                    <p className="text-blue-100">Gestiona todo el sistema GlobalStore</p>
                </div>
                        ...
                        <CardContent>
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
                                    ...
                                    <span className="text-2xl font-bold text-blue-600">$4,567</span>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <CardContent>
                            <div className="space-y-3">
                                <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-gray-900">Nueva tienda registrada</p>
                                ...
                                <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-gray-900">Nuevo proveedor aprobado</p>
                                ...
                                <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-gray-900">50 nuevos productos agregados</p>
